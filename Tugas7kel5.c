...
int main (){
    ...
    while (fgets(baris, max_len, fp_tanaman)){
        strcpy(nama_tanaman[n_tanaman],baris);
        n_tanaman += 1;
    }
    ...
    scanf("%d",&idx_tujuan);
    idx_tujuan-=1;
    int jarak_final[n_tanaman]; //Jarak akhir ke masing2 pohon
    ...
    //Inisiasi jarak awal pada vertex yang terhubung dengan vertex awal
